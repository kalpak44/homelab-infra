<!-- Managed by homelab-infra — terraform/github/bunker-party/agent-prompts/ai-maintenance-agent.md -->
<!-- Edits made here in the target repo are overwritten by `just deploy github bunker-party`. -->
