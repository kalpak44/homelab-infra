<!-- Managed by homelab-infra — terraform/github/code-viewer-bot/agent-prompts/ai-maintenance-agent.md -->
<!-- Edits made here in the target repo are overwritten by `just deploy github code-viewer-bot`. -->
